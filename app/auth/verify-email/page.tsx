      ...
      <div className="w-full max-w-md text-center">
        <Link href="/" className="flex flex-col items-center gap-3 mb-10">
          ...
          <div>
            ...
            <div className="text-[#1F4E79] text-xs tracking-[0.15em] uppercase mt-0.5">Kapital Exchange Portal</div>
          </div>
        </Link>

        <div className="bg-white rounded-2xl p-8 border border-[#E4E7EC] text-left">
          <div className="w-12 h-12 bg-[#1F4E79]/10 border border-[#1F4E79]/20 rounded-xl flex items-center justify-center mx-auto mb-5">
            <svg className="w-6 h-6 text-[#1F4E79]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div className="mt-5 pt-4 border-t border-[#E4E7EC] text-center">
