      ...
      <div className="min-h-screen ed bg-white flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md text-center">
          ...
          <div className="bg-white rounded-2xl p-10 border border-[#E4E7EC]">
            ...
            <h1 className="font-display text-2xl font-bold text-[#22201B] mb-2">Email envoyé</h1>
          ...
          <p className="text-[#B3AA9C] text-xs mt-4">
            Pas reçu ?{" "}
            <button onClick={() => setSent(false)} className="text-[#918A7C] hover:text-[#575249] underline transition-colors">
              Réessayer
            </button>
