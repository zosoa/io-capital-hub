...
function SkeletonCard() {
  return (
    <div className="rounded-xl border border-[#E4E7EC] bg-white p-5 flex flex-col animate-pulse">
      <div className="flex items-center justify-between mb-3">
        <div className="h-5 w-24 bg-white rounded-full"/>
        <div className="h-4 w-12 bg-white rounded"/>
      </div>
      <div className="h-4 w-4/5 bg-white rounded mb-2"/>
      <div className="h-3 w-full bg-white rounded mb-1"/>
      <div className="h-3 w-3/4 bg-white rounded mb-4"/>
      <div className="border-t border-[#E4E7EC] pt-3 mt-auto flex gap-2">
...
export default function DealFlowLoading() {
  return (
    <div className="p-6 md:p-8 pt-[68px] md:pt-8 max-w-5xl mx-auto">
      <div className="mb-8">
        <div className="h-7 w-40 bg-white rounded mb-2 animate-pulse"/>
        <div className="h-4 w-64 bg-white rounded animate-pulse"/>
      </div>
      <div className="mb-6 flex gap-2">
        {[1,2,3,4].map(i => (
          <div key={i} className="h-7 w-28 bg-white rounded-full animate-pulse"/>
        ))}
      </div>
