  ...
  return (
    <div className="p-6 md:p-8 pt-[68px] md:pt-8 max-w-3xl mx-auto">
      <div className="flex items-start justify-between gap-4 mb-8">
        <div>
          <h1 className="font-display text-2xl md:text-3xl font-bold text-[#22201B] mb-1.5">Notifications</h1>
              ...
              <div className={`rounded-xl border p-4 transition-colors ${a.bg} ${!n.read_at ? "ring-1 ring-[#BC5A34]/30" : ""} hover:border-white/20`}>
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {n.body && (
                      <p className="text-[#6B655B] text-xs leading-relaxed mt-1.5 whitespace-pre-line">{n.body}</p>
                    )}
                  </div>
                </div>
              </div>
      ...
      <div className="mt-8">
        <Link href="/dashboard" className="text-[#918A7C] hover:text-[#575249] text-sm transition-colors inline-flex items-center gap-1.5">
