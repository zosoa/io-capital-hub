...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="text-[#1F4E79] text-xs uppercase tracking-[0.15em] font-semibold mb-3">
      {children}
    </div>
  );
}
      ...
      <div className="print:hidden bg-white border-b border-[#E8E2D9] px-6 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={() => typeof window !== "undefined" && window.print()}
            className="flex items-center gap-1.5 text-xs font-medium text-[#1F4E79] border border-[#1F4E79]/30 px-3 py-1.5 rounded-lg hover:bg-[#1F4E79]/5 transition-colors">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-10 print:py-6">
        ...
        <div className="bg-white rounded-2xl p-8 mb-6 border border-[#E8E2D9] shadow-sm">
          <div className="flex items-start gap-6">
            {/* Logo placeholder */}
            <div className="w-16 h-16 bg-[#1F4E79]/10 border-2 border-[#1F4E79]/20 rounded-xl flex items-center justify-center flex-shrink-0 text-[#1F4E79] font-bold text-xl">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-start justify-between gap-4 flex-wrap">
                ...
                {project.amount_requested && (
                  <div className="text-right flex-shrink-0">
                    <div className="text-3xl font-bold text-[#1F4E79]">
              ...
              <div className="flex flex-wrap gap-2 mt-4">
                ...
                {project.stage && (
                  <span className="bg-[#1F4E79]/10 text-[#1F4E79] text-xs px-3 py-1 rounded-full font-medium">
        ...
        <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                ...
                {project.amount_requested && (
                  <div className="p-3 bg-[#FFFFFF] rounded-lg">
                    ...
                    <div className="text-[#1F4E79] font-bold text-sm">
                      {formatCurrency(project.amount_requested, project.currency)}
                    </div>
                  </div>
                )}
              ...
              <div className="bg-white rounded-xl p-6 border border-[#E8E2D9] shadow-sm">
                ...
                {project.job_creation_expected && (
                  <div className="flex items-baseline gap-2 mb-3">
                    <span className="text-3xl font-bold text-[#1F4E79]">{project.job_creation_expected}</span>
          ...
          <div className="space-y-5">
            ...
            {/* CEO Summit stamp */}
            <div className="rounded-xl p-5 border border-[#1F4E79]/20 bg-[#1F4E79]/5">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[#1F4E79] text-xs font-semibold uppercase tracking-wider">Dossier qualifié</span>
              </div>
