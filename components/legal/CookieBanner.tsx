  ...
  return (
    ...
    >
      <div className="flex items-start gap-3 mb-3">
        <span className="flex-shrink-0 w-8 h-8 rounded-lg bg-[#BC5A34]/10 border border-[#BC5A34]/20 text-[#BC5A34] flex items-center justify-center">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[#575249] text-xs leading-relaxed mt-1.5">
            ...
            {" "}
            <Link href="/legal/privacy" className="text-[#BC5A34] hover:text-[#A44B29] underline">
              En savoir plus
            </Link>.
          </p>
        </div>
